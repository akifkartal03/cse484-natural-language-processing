...
class HW1:
    ...
    def get_results(self):
        ...
        self.__initFields()
        self.__wordList1 = self.__testFile3.read().splitlines()
        self.__numberOfWord = len(self.__wordList1)
        print("Syntactic distance accuracy")
        print("-----------------------------")
        print("word2vec: ", end="")
        a = self.__calculate_sem_sim_normal()
        print(a)
        self.__grp.append(a)
        print("syllable based: ", end="")
        b = self.__calculate_sem_sim_syl()
        print(b)
        self.__grp.append(b)
        print("-------------------------------")
        self.__wordList1 = self.__testFile1.read().splitlines()
        self.__numberOfWord = len(self.__wordList1)
        self.__drawGraph("Syntactic distance accuracy")
        self.__grp = []

        print("Semantic distance accuracy")
        print("-----------------------------")
        print("word2vec: ", end="")
        a = self.__calculate_sem_sim_normal()
        print(a)
        ...
        self.__grp.append(a)
        self.__grp.append(b)
        self.__drawGraph("Semantic distance accuracy")
        self.__grp = []

        self.__wordList1 = self.__testFile4.read().splitlines()
        self.__numberOfWord = len(self.__wordList1)
        print("Syntactic analogy accuracy")
        print("-----------------------------")
        print("word2vec: ", end="")
        a = self.__calculate_syn_sim_normal()
        print(a)
        print("syllable based: ", end="")
        b = self.__calculate_syn_sim_syl()
        print(b)
        print("-------------------------------")
        self.__grp.append(a)
        self.__grp.append(b)
        self.__drawGraph("Syntactic analogy accuracy")
        self.__grp = []
        self.__wordList1 = self.__testFile2.read().splitlines()
        self.__numberOfWord = len(self.__wordList1)

        print("Semantic analogy accuracy")
        print("-----------------------------")
        print("word2vec: ", end="")
        a = self.__calculate_syn_sim_normal()
        print(a)
        ...
        self.__grp.append(a)
        self.__grp.append(b)
        self.__drawGraph("Semantic analogy accuracy")
        self.__grp = []
        self.__closeFiles()
